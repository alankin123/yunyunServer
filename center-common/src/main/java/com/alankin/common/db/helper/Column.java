package com.alankin.common.db.helper;

import com.alankin.common.db.helper.ForeignKey.ReferenceKey;
...
public class Column implements java.io.Serializable, Cloneable {
	...
	// result = "com.alankin.common.utils.DateUtils.getSystemDate()";

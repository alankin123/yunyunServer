...
import com.alankin.common.vo.InterfaceRespVO;
...
//		logger.info("========{}===={}=====收到http请求：调用模块：{}，服务：{}，方法：{}=================", Utils.getIpAddr(request), request.getParameter("token"), mode,
//		        service, method);
//
...
//		}
//		logger.info("=================返回http响应：{}:{}=================", resp.getState(), resp.getMsg());
//		if (!resp.isSuccess()) {
//			logger.error(resp + "");
